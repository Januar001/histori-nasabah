    ...
    <div class="row">
        <div class="col-12 mb-4">
            <ul class="nav nav-tabs" id="nasabahTabs" role="tablist">
                ...
                <!-- TAB ASSIGN PETUGAS -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="assign-tab" data-bs-toggle="tab" data-bs-target="#assign-petugas" type="button"
                        role="tab">
                        <i class="fas fa-user-tie me-1"></i>Assign Petugas
                        @if($nasabah->petugas)
                            <span class="badge bg-success ms-1">Assigned</span>
                        @else
                            <span class="badge bg-warning ms-1">Unassigned</span>
                        @endif
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="nasabahTabsContent">
                ...
                <div class="tab-pane fade show active" id="info" role="tabpanel">
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="card border-0 h-100">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-chart-bar me-2 text-success"></i>Status & Kualitas
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ \App\Helpers\QualityHelper::getQualityBadge($nasabah->kualitas) }} fs-6">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $nasabah->tgl_macet ? \Carbon\Carbon::parse($nasabah->tgl_macet)->format('d M Y') : '-' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Tanggal Lunas</th>
                                            <td>{{ $nasabah->tglunas ? \Carbon\Carbon::parse($nasabah->tglunas)->format('d M Y') : '-' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                @if ($nasabah->petugas)
                                                    <span
                                                        class="badge bg-info">{{ $nasabah->petugas->nama_petugas }}</span>
                                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success">{{ $nasabah->namaao ?: '-' }} -
                                                    {{ $nasabah->kdao ?: '-' }}</span></td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Tanggal Ditangani</th>
                                            <td>{{ $nasabah->tanggal_ditangani ? $nasabah->tanggal_ditangani->format('d M Y') : 'Belum ditangani' }}
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="card border-0">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-map-marker-alt me-2 text-warning"></i>Alamat
                                        Lengkap</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                ...
                <div class="tab-pane fade" id="financial" role="tabpanel">
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="card border-0 h-100">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-money-bill-wave me-2 text-success"></i>Informasi
                                        Pinjaman</h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                                        <tr>
                                            ...
                                            <td class="text-end"><strong class="text-primary">Rp
                                                    {{ number_format($nasabah->plafon, 0, ',', '.') }}</strong></td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Baki Debet</th>
                                            <td class="text-end"><strong class="text-danger">Rp
                                                    {{ number_format($nasabah->bakidebet, 0, ',', '.') }}</strong></td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Baki DB</th>
                                            <td class="text-end">Rp {{ number_format($nasabah->bakidb, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                {{ $nasabah->tglpinjam ? \Carbon\Carbon::parse($nasabah->tglpinjam)->format('d M Y') : '-' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Tanggal Jatuh Tempo</th>
                                            <td class="text-end">
                                                {{ $nasabah->tgltempo ? \Carbon\Carbon::parse($nasabah->tgltempo)->format('d M Y') : '-' }}
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="card border-0 h-100">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-calculator me-2 text-info"></i>Detail Pokok &
                                        Bunga</h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                                        <tr>
                                            ...
                                            <td class="text-end">Rp {{ number_format($nasabah->nompokok, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Hari Pokok</th>
                                            <td class="text-end">{{ number_format($nasabah->hrpokok, 0, ',', '.') }} hari
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <span
                                                    class="badge {{ \App\Helpers\QualityHelper::getTunggakanColor($nasabah->xtungpok) }}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">Rp {{ number_format($nasabah->nombunga, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Hari Bunga</th>
                                            <td class="text-end">{{ number_format($nasabah->hrbunga, 0, ',', '.') }} hari
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <span
                                                    class="badge {{ \App\Helpers\QualityHelper::getTunggakanColor($nasabah->xtungbu) }}">
                                                    {{ number_format($nasabah->xtungbu, 0, ',', '.') }}
                                                </span>
                                                Tunggakan</td>
                                        </tr>
                                    </table>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="card border-0 h-100">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-shield-alt me-2 text-warning"></i>PPAP & Nilai
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                                        <tr>
                                            ...
                                            <td class="text-end">Rp {{ number_format($nasabah->nilckpn, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Nilai Liquid</th>
                                            <td class="text-end">Rp {{ number_format($nasabah->nilliquid, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Nilai Non-Liquid</th>
                                            <td class="text-end">Rp {{ number_format($nasabah->nilnliquid, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">Minimum PPAP</th>
                                            <td class="text-end">Rp {{ number_format($nasabah->min_ppap, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted small">PPAP WD</th>
                                            <td class="text-end">Rp {{ number_format($nasabah->ppapwd, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div class="tab-pane fade" id="collateral" role="tabpanel">
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="card border-0 h-100">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-tags me-2 text-primary"></i>Klasifikasi Debitur
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                        ...
                        @if ($nasabah->catatan)
                            <div class="col-12 mb-4">
                                <div class="card border-0">
                                    <div class="card-header bg-white py-3">
                                        <h6 class="mb-0"><i class="fas fa-sticky-note me-2 text-warning"></i>Catatan
                                        </h6>
                                    </div>
                                    <div class="card-body">
                ...
                <div class="tab-pane fade" id="janji" role="tabpanel">
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-md-4 mb-4">
                            <div class="card border-0">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-plus-circle me-2 text-success"></i>Janji Bayar
                                        Baru</h6>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('janji-bayar.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control form-control-sm" id="tanggal_janji"
                                                name="tanggal_janji" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" class="form-control" id="nominal_janji"
                                                    name="nominal_janji" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control form-control-sm" id="keterangan" name="keterangan" rows="3"
                                                placeholder="Detail janji bayar..." required></textarea>
                                        </div>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="card border-0">
                                <div class="card-header bg-white py-3">
                                    <h6 class="mb-0"><i class="fas fa-list me-2 text-primary"></i>History Janji Bayar
                                    </h6>
                                </div>
                                <div class="card-body">
                                    @if ($nasabah->janjiBayar->count() > 0)
                                        ...
                                        @else border-warning @endif ps-3 mb-3">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div
                                                            ...
                                                            <h6 class="mb-0 text-primary">Rp
                                                                {{ number_format($janji->nominal_janji, 0, ',', '.') }}
                                                            </h6>
                                                            <span
                                                                class="badge 
                                                ...
                                                @if (auth()->user()->role == 'admin')
                                                    <div class="mt-2">
                                                        <form
                                                            action="{{ route('janji-bayar.update-status', $janji->id) }}"
                                                            method="POST" class="d-inline">
                                                            @csrf
                                                            <select name="status" class="form-select form-select-sm"
                                                                onchange="this.form.submit()">
                                                                <option value="pending"
                                                                    {{ $janji->status == 'pending' ? 'selected' : '' }}>
                                                                    Pending</option>
                                                                <option value="sukses"
                                                                    {{ $janji->status == 'sukses' ? 'selected' : '' }}>
                                                                    Sukses</option>
                                                                <option value="gagal"
                                                                    {{ $janji->status == 'gagal' ? 'selected' : '' }}>Gagal
                                                                </option>
                                                            </select>
                                                        </form>
                                                    </div>
                ...
                <div class="tab-pane fade" id="history" role="tabpanel">
                    <div class="card border-0 mt-3">
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0"><i class="fas fa-exchange-alt me-2 text-primary"></i>Riwayat Perubahan
                                Kolektibilitas</h5>
                        </div>
                        <div class="card-body">
                                        ...
                                        @else bg-secondary @endif">
                                            ...
                                            <div class="timeline-content ms-3 flex-grow-1">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <strong
                                                        class="text-primary">{{ \Carbon\Carbon::parse($history->tanggal_perubahan)->format('d M Y H:i') }}</strong>
                                                    <span
                                                        class="badge bg-light text-dark small">{{ $history->petugas }}</span>
                                                </div>

                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <span
                                                        class="badge {{ \App\Helpers\QualityHelper::getQualityBadge($history->kolektibilitas_sebelum) }} fs-6">
                                                        {{ \App\Helpers\QualityHelper::getQualityLabel($history->kolektibilitas_sebelum) }}
                                                    </span>
                                                    <i class="fas fa-arrow-right mx-3 text-muted"></i>
                                                    <span
                                                        class="badge {{ \App\Helpers\QualityHelper::getQualityBadge($history->kolektibilitas_sesudah) }} fs-6">
                ...
                <!-- Tab 6: Assign Petugas -->
                <div class="tab-pane fade" id="assign-petugas" role="tabpanel">
                    <div class="row mt-3">
                        <div class="col-12 col-lg-8 mx-auto">
                            <div class="card border-0">
                                ...
                                <div class="card-body">
                                    <!-- Status Current Petugas -->
                                    <div class="alert 
                                        @if($nasabah->petugas) alert-success 
                                        @else alert-warning @endif mb-4">
                                        <div class="d-flex align-items-center">
                                            <i class="fas 
                                                @if($nasabah->petugas) fa-check-circle 
                                                @else fa-exclamation-triangle @endif me-2"></i>
                                            <div>
                                                <strong>
                                                    @if($nasabah->petugas)
                                                        Sudah diassign ke petugas
                                                    @else
                                            ...
                                            <div class="card border">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center mt-2">
                                                        ...
                                                        <div>
                                                            <strong class="d-block">{{ $nasabah->petugas->nama_petugas }}</strong>
                                            ...
                                            <div class="card border">
                                                <div class="card-body text-center">
                                                    ...
                                                    <span class="badge 
                                                        ...
                                                        @elseif($nasabah->petugas->divisi == 'Kolektor') bg-danger
                                                        @else bg-info @endif mt-2">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <div class="card border">
                                                <div class="card-body text-center">
                                                    ...
                                                    <span class="badge 
                                                        @if ($nasabah->petugas->status_aktif == 'true') bg-success
                                                        @else bg-secondary @endif mt-2">
                                                        {{ $nasabah->petugas->status_aktif == 1 ? 'Aktif' : 'Non Aktif' }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-12 col-md-6">
                                            <div class="card border">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Kontak Petugas</small>
                                                    <div class="mt-2">
                                                        @if($nasabah->petugas->email)
                                                        <div class="d-flex align-items-center mb-2">
                                                            <i class="fas fa-envelope text-muted me-2"></i>
                                                            <small>{{ $nasabah->petugas->email }}</small>
                                                        </div>
                                                        @endif
                                                        @if($nasabah->petugas->telepon)
                                                        <div class="d-flex align-items-center">
                                                            <i class="fas fa-phone text-muted me-2"></i>
                                                            <small>{{ $nasabah->petugas->telepon }}</small>
                                                        </div>
                                                        @endif
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="card border">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Tanggal Penanganan</small>
                                                    <div class="d-flex align-items-center mt-2">
                                                        <i class="fas fa-calendar text-primary me-2"></i>
                                                        <strong>
                                                            {{ $nasabah->tanggal_ditangani ? $nasabah->tanggal_ditangani->format('d M Y') : 'Belum ditangani' }}
                                                        </strong>
                                                    </div>
                                                    @if($nasabah->tanggal_ditangani)
                                                    <small class="text-muted">
                                                        ({{ $nasabah->tanggal_ditangani->diffForHumans() }})
                                                    </small>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    <div class="card border mb-4">
                                        <div class="card-header bg-light py-2">
                                            <small class="text-muted"><i class="fas fa-sticky-note me-1"></i>Catatan Penanganan</small>
                                        </div>
                                        <div class="card-body">
                                            <p class="mb-0">{{ $nasabah->catatan_penanganan }}</p>
                                        </div>
                                    </div>
                                    @endif
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        ...
                                                        <select name="petugas_id" class="form-select" required>
                                                            <option value="">Pilih Petugas Penanganan...</option>
                                                            @foreach ($petugasList as $petugas)
                                                                <option value="{{ $petugas->id }}"
                                                                    {{ $nasabah->petugas_id == $petugas->id ? 'selected' : '' }}>
                                                                    [{{ $petugas->divisi }}] {{ $petugas->nama_petugas }} 
                                                        ...
                                                        <small class="text-muted">Pilih petugas yang akan menangani nasabah ini</small>
                                                    </div>
                                                    
                                                    <div class="col-12">
                                                        <label class="form-label small fw-bold">Catatan Penanganan</label>
                                                        <textarea name="catatan_penanganan" class="form-control" rows="3" 
                                                            placeholder="Tambahkan catatan mengenai penanganan nasabah, rencana tindakan, atau informasi penting lainnya...">{{ $nasabah->catatan_penanganan }}</textarea>
                                                        <small class="text-muted">Opsional: Catatan ini akan membantu petugas dalam penanganan</small>
                                                    </div>
                                    ...
                                    <div class="mt-3 text-center">
                                        <small class="text-muted">
                                            ...
                                            Petugas dapat melihat nasabah ini di dashboard mereka
                                        </small>
                                    </div>
                                    @endif
                                </div>
